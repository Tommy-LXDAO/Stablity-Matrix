...
class TestControllerTest {
    ...
    private void validateTombstoneInfo(TroubleEntity entity) {
        ...
        assertEquals(AArch64Tombstone.StackDumpInfo.StackFrame.AddressType.OFFSET, frames.get(0).getAddressType(), "第一个堆栈帧地址类型不正确");
        ...
        assertEquals(AArch64Tombstone.StackDumpInfo.StackFrame.AddressType.OFFSET, frames.get(1).getAddressType(), "第二个堆栈帧地址类型不正确");
        ...
        assertEquals(AArch64Tombstone.StackDumpInfo.StackFrame.AddressType.OFFSET, frames.get(2).getAddressType(), "第三个堆栈帧地址类型不正确");
